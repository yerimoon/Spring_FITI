    ...
    <div class="container-fluid h-100">
        ...
        <div class="container-fluid">
            <div class="col-md-8 col-sm-12 test">
                <div class="row">
                    <button class="btn btn-primary pull-right" type="button" onclick="location.href='/FRONT/views/board/notice/notice_modify.html'">수정하기</button>
                    <button class="btn btn-primary pull-right" type="button" onclick="location.href='/FRONT/views/board/notice/notice_board.html'">목록으로</button>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="titlebox">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="/FRONT/resource/img/location/site01.jpg" width="100%" alt="...">

                                </div>
                                <div class="item">
                                    <img src="/FRONT/resource/img/location/site02.jpg" width="100%" alt="...">

                                </div>
                                <div class="item">
                                    <img src="/FRONT/resource/img/location/site03.jpg" width="100%" alt="...">

                                </div>
                                <div class="item">
                                    <img src="/FRONT/resource/img/location/site04.jpg" width="100%" alt="...">

                                </div>
                                <div class="item">
                                    <img src="/FRONT/resource/img/location/site05.jpg" width="100%" alt="...">
        ...
        $('.test:last-child').scroll(function () {
            ...
            */
            ...
            if ($('.test:last-child').scrollTop() + $('.test:last-child').height() >= replyTotalHeight) {
                ...
                //         <img src="/FRONT/resource/img/load.gif" alt="">
                //     </div>
                // `);
                // $('#loadingImg').remove();
                replyAppendTest();
